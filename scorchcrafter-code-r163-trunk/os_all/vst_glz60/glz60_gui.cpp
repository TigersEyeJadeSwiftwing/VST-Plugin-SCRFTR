...
AEffGUIEditor* createEditor (AudioEffectX* ScGLZ60)
{
	return new PlgEditor_Glz (ScGLZ60);
}
//------------------------------------------------------------------------------------
PlgEditor_Glz::PlgEditor_Glz (void* ptr)
: AEffGUIEditor (ptr)
{
	rect.left   = 0;
	rect.top    = 0;
...
PlgEditor_Glz::~PlgEditor_Glz()
{
	// delete GUIbackGr;
}
//------------------------------------------------------------------------------------
bool PlgEditor_Glz::open (void* ptr)
{
...
//	DisplaySide = ((ScGLZ60*)effect)->getParameter(kGuiCurrentPanel);

	if(((ScGLZ60*)effect)->getParameter(kGuiPanelButtonA) > 0.50f) SetUpFront();

	if(((ScGLZ60*)effect)->getParameter(kGuiPanelButtonB) > 0.50f) SetUpBack();

	if(((ScGLZ60*)effect)->getParameter(kGuiPanelButtonC) > 0.50f) SetUpAux();
...
//		setParameter (i, ((ScGLZ60*)effect)->getParameter (i));

	return true;
}
//------------------------------------------------------------------------------------
void PlgEditor_Glz::SetUpFront()
{
	if(!frame) return;
	...
	pGuiKnobSm = new CBitmap ("PlgknobSm");
	...
	PanelButton[0]->setValue(((ScGLZ60*)effect)->getParameter(kGuiPanelButtonA));
	PanelButton[1]->setValue(((ScGLZ60*)effect)->getParameter(kGuiPanelButtonB));
	PanelButton[2]->setValue(((ScGLZ60*)effect)->getParameter(kGuiPanelButtonC));
	...
	kKnob[2] = new CAnimKnob(CRect(227,197,291,261),this,kInputVol,pGuiKnob,CPoint(0,0));

	kKnob[0]->setValue(((ScGLZ60*)effect)->getParameter(kGainControl));
	kKnob[1]->setValue(((ScGLZ60*)effect)->getParameter(kMasterVol));
	kKnob[2]->setValue(((ScGLZ60*)effect)->getParameter(kInputVol));

	kKnobSm[0] = new CAnimKnob(CRect(400, 220, 450, 270),this,kEQstackLow,pGuiKnobSm,CPoint(0,0));
	kKnobSm[1] = new CAnimKnob(CRect(520, 220, 570, 270),this,kEQstackMid,pGuiKnobSm,CPoint(0,0));
	kKnobSm[2] = new CAnimKnob(CRect(640, 220, 690, 270),this,kEQstackHigh,pGuiKnobSm,CPoint(0,0));
	kKnobSm[3] = new CAnimKnob(CRect(520, 130, 570, 180),this,kEQstackContour,pGuiKnobSm,CPoint(0,0));
	kKnobSm[4] = new CAnimKnob(CRect(640, 130, 690, 180),this,kEQstackPres,pGuiKnobSm,CPoint(0,0));
	kKnobSm[5] = new CAnimKnob(CRect(350, 220, 400, 270),this,kPreEQstackLow,pGuiKnobSm,CPoint(0,0));
	kKnobSm[6] = new CAnimKnob(CRect(470, 220, 520, 270),this,kPreEQstackMid,pGuiKnobSm,CPoint(0,0));
	kKnobSm[7] = new CAnimKnob(CRect(590, 220, 640, 270),this,kPreEQstackHigh,pGuiKnobSm,CPoint(0,0));
	kKnobSm[8] = new CAnimKnob(CRect(470, 130, 520, 180),this,kPreEQstackContour,pGuiKnobSm,CPoint(0,0));
	kKnobSm[9] = new CAnimKnob(CRect(590, 130, 640, 180),this,kPreEQstackPres,pGuiKnobSm,CPoint(0,0));
	...
	for(int y = 0; y < 10; y++)
	{
		kKnobSm[y]->setValue(((ScGLZ60*)effect)->getParameter(kEQstackLow + y));
		newFrame->addView(kKnobSm[y]);
	}

	kBtn_Stereo = new COnOffButton(CRect(20,80,40,100),this,kMonoStereoControl,pGuiButton);
	kBtn_Bright = new COnOffButton(CRect(20,110,40,130),this,kBtnBright,pGuiButton);

	kBtn_Stereo->setValue(((ScGLZ60*)effect)->getParameter(kMonoStereoControl));
	kBtn_Bright->setValue(((ScGLZ60*)effect)->getParameter(kBtnBright));
...
void PlgEditor_Glz::SetUpBack()
{
	...
	for(x = kSmpRenderOn1x; x <= kSmpRenderOnOFF; x++)
	{
		...
		SamplingOn[x-kSmpRenderOn1x]->setValue(((ScGLZ60*)effect)->getParameter(x));
	...
	for(x = kSmpRenderOff1x; x <= kSmpRenderOffOFF; x++)
	{
		...
		SamplingOff[x-kSmpRenderOff1x]->setValue(((ScGLZ60*)effect)->getParameter(x));
	...
	kBtn_TStackEven->setValue(((ScGLZ60*)effect)->getParameter(kToneStFlatEven));
	kBtn_TStackShaped[0]->setValue(((ScGLZ60*)effect)->getParameter(kToneStShapedA));
	kBtn_TStackShaped[1]->setValue(((ScGLZ60*)effect)->getParameter(kToneStShapedB));
	kBtn_TStackShaped[2]->setValue(((ScGLZ60*)effect)->getParameter(kToneStShapedC));
	kBtn_TStackShaped[3]->setValue(((ScGLZ60*)effect)->getParameter(kToneStShapedD));
	kBtn_TStackShaped[4]->setValue(((ScGLZ60*)effect)->getParameter(kToneStShapedE));
	kBtn_TStackShaped[5]->setValue(((ScGLZ60*)effect)->getParameter(kToneStShapedF));
	kBtn_CabMic->setValue(((ScGLZ60*)effect)->getParameter(kInternalCabOff));
	kBtn_CabMicSelect[0]->setValue(((ScGLZ60*)effect)->getParameter(kInternalCabA));
	kBtn_CabMicSelect[1]->setValue(((ScGLZ60*)effect)->getParameter(kInternalCabB));
	kBtn_CabMicSelect[2]->setValue(((ScGLZ60*)effect)->getParameter(kInternalCabC));
	kBtn_CabMicSelect[3]->setValue(((ScGLZ60*)effect)->getParameter(kInternalCabD));
	kBtn_CabMicSelect[4]->setValue(((ScGLZ60*)effect)->getParameter(kInternalCabE));
	kBtn_CabMicSelect[5]->setValue(((ScGLZ60*)effect)->getParameter(kInternalCabF));
	kDynamicToneOn->setValue(((ScGLZ60*)effect)->getParameter(kDynamicEnabled));
...
void PlgEditor_Glz::SetUpAux()
{
	...
	kBitDepthOn[0]->setValue(((ScGLZ60*)effect)->getParameter(kSmpBitOn32));
	kBitDepthOn[1]->setValue(((ScGLZ60*)effect)->getParameter(kSmpBitOn64));
	kBitDepthOn[2]->setValue(((ScGLZ60*)effect)->getParameter(kSmpBitOn128));
	kBitDepthOff[0]->setValue(((ScGLZ60*)effect)->getParameter(kSmpBitOff32));
	kBitDepthOff[1]->setValue(((ScGLZ60*)effect)->getParameter(kSmpBitOff64));
	kBitDepthOff[2]->setValue(((ScGLZ60*)effect)->getParameter(kSmpBitOff128));
...
//------------------------------------------------------------------------------------
void PlgEditor_Glz::valueChanged(CControl* pControl)
{
	//-- valueChanged is called whenever the user changes one of the controls in the User Interface (UI)
	((ScGLZ60*)effect)->setParameterAutomated(pControl->getTag(), pControl->getValue());
}
//------------------------------------------------------------------------------------
void PlgEditor_Glz::setParameter(VstInt32 index, float value)
{
	...
	if(index == kGuiPanelButtonA)
	{
		if(frame)
		{
			...
			{
				SetUpFront();
//				((ScGLZ60*)effect)->setParameterAutomated(kGuiPanelButtonB, 0.0f);
//				((ScGLZ60*)effect)->setParameterAutomated(kGuiPanelButtonC, 0.0f);
			}
		}
	}
	if(index == kGuiPanelButtonB)
	{
		if(frame)
		{
			...
			{
				SetUpBack();
//				((ScGLZ60*)effect)->setParameterAutomated(kGuiPanelButtonA, 0.0f);
//				((ScGLZ60*)effect)->setParameterAutomated(kGuiPanelButtonC, 0.0f);
			}
		}
	}
...
//	{
	...
	//		((ScGLZ60*)effect)->updateDisplay();
		//	frame->invalid();
	//		DisplaySide = value;
	//	}
//	}
	if (((ScGLZ60*)effect)->getParameter(kGuiPanelButtonA) > 0.50f)
	{
		...
		if((index >= kEQstackLow) && (index <= kPreEQstackPres))
		{
			if(kKnobSm[index-kEQstackLow])
			{
				kKnobSm[index-kEQstackLow]->setValue(value);
				kKnobSm[index-kEQstackLow]->invalid();
			}
		}
	...
	if (((ScGLZ60*)effect)->getParameter(kGuiPanelButtonB) > 0.50f)
	{
	...
	if (((ScGLZ60*)effect)->getParameter(kGuiPanelButtonC) > 0.50f)
	{
