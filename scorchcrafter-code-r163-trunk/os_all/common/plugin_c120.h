...
//! ----------------------------------------------------------------------------------------------------------------
public:
	SC_C120_Amp_Head(double sRt = 44100.0);							//! Create an instance of the plug-in, setting a starting sample rate.  (Default is 44,100 kHz.)
	~SC_C120_Amp_Head();
...
private:
	...
	Tube_Bank_J *PluGin[4][2];
	FIR_Multi_EQ *CabCurves[2][6];
