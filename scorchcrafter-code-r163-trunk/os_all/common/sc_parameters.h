...
enum SC_Parameters_FP
{
	...
	ScPrmF_PreEQ_Mid,
	ScPrmF_PreEQ_High,
	ScPrmF_PreEQ_Contour,
	ScPrmF_PreEQ_Floor,
	ScPrmF_PreEQ_Presence,
	ScPrmF_MAX_COUNT
};
enum SC_Parameters_INT
{
	...
	ScPrmI_CabMic_Num,
	ScPrmI_TStack_Shape,
	ScPrmI_TStack_ShapeNum,
	ScPrmI_TStack_Dynamic,
	ScPrmI_TStack_Before_Power,
	ScPrmI_ImpulseLength_Amp,
	ScPrmI_ImpulseLength_Cab,
	ScPrmI_MAX_COUNT
};
