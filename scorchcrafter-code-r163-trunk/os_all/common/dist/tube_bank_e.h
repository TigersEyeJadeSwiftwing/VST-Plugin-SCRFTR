#ifndef __dist_tube_bank_e__
#define __dist_tube_bank_e__
...
class Tube_Bank_E : public SampleBank_Cst
{
public:
	Tube_Bank_E(fsx spRate, fhx mdfr);
	~Tube_Bank_E();
	void InitTubes();
	void zeroAllSamples();
...
private:
	...
	fsx s_tSpeed;
	flx l_tSpeed;
	fhx h_tPos[DIST_TB_MAX_STAGES];
	fsx s_tPos[DIST_TB_MAX_STAGES];
	flx l_tPos[DIST_TB_MAX_STAGES];
	...
	fhx h_dfltA;
	fhx h_dfltB;
	fhx h_qFiltT[DIST_TB_MAX_STAGES][Dist_TB_TubeFreqStages];
	fhx h_eff;
	...
	fsx s_dfltA;
	fsx s_dfltB;
	fsx s_qFiltT[DIST_TB_MAX_STAGES][Dist_TB_TubeFreqStages];
	fsx s_eff;
	...
	flx l_dfltA;
	flx l_dfltB;
	flx l_qFiltT[DIST_TB_MAX_STAGES][Dist_TB_TubeFreqStages];
	flx l_eff;
	...
	SC_Tube_Stage *PreAmpD[Dist_TB_PreAmp_Stages_Max];
	SC_Tube_Stage *PowerAmpD[DIST_TB_MAX_STAGES];
