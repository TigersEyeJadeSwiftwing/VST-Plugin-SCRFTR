...
private:
	...
	fsx s_tSpeed;
	flx l_tSpeed;
	fhx h_tPos[DIST_TBD_MAX_STAGES];
	fsx s_tPos[DIST_TBD_MAX_STAGES];
	flx l_tPos[DIST_TBD_MAX_STAGES];
	...
	fhx h_dfltA;
	fhx h_dfltB;
	fhx h_qFiltT[DIST_TBD_MAX_STAGES][Dist_TBD_TubeFreqStages];
	fhx h_eff;
	...
	fsx s_dfltA;
	fsx s_dfltB;
	fsx s_qFiltT[DIST_TBD_MAX_STAGES][Dist_TBD_TubeFreqStages];
	fsx s_eff;
	...
	flx l_dfltA;
	flx l_dfltB;
	flx l_qFiltT[DIST_TBD_MAX_STAGES][Dist_TBD_TubeFreqStages];
	flx l_eff;
	...
	SC_Diode *PreAmpD[Dist_TBD_PreAmp_Stages_Max];
	SC_Diode *PowerAmpD[DIST_TBD_MAX_STAGES];
