#ifndef __dist_tube_bank_h__
#define __dist_tube_bank_h__
...
class Tube_Bank_H : public SampleBank_Cst
{
public:
	Tube_Bank_H(const SC_TubeDistortion_Params *initParams, fsx spRate);
	virtual ~Tube_Bank_H();
	void InitTubes();
	void zeroAllSamples();
