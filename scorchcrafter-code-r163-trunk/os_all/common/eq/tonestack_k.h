#ifndef __SC_eq_tstack_K__
#define __SC_eq_tstack_K__
...
#define SC_NUM_TSTACK_K_DEFS_AMP 6
#define SC_NUM_TSTACK_K_DEFS_CAB 6
#define SC_NUM_TSTACK_K_DEFS 6

class ToneStack_K
{
public:
	ToneStack_K(const fsx nRate, const SC_ToneStack_Params inpParams);
	~ToneStack_K();
	...
	void SetAmpShapeNum(int inp) { curAmp=inp; if(inp>SC_NUM_TSTACK_K_DEFS_AMP) inp=SC_NUM_TSTACK_K_DEFS_AMP-1; };
...
//	Cst_EQ *AmpHeadEQ[SC_NUM_TSTACK_K_DEFS_AMP][TStack_Max_Elements];
	BTW_LP *AmpHeadEQA[SC_NUM_TSTACK_K_DEFS_AMP][TStack_Max_Elements];
	BTW_LP *AmpHeadEQB[SC_NUM_TSTACK_K_DEFS_AMP][TStack_Max_Elements];
