#ifndef __Jykr_amp_head__
#define __Jykr_amp_head__
...
//!-------------------------------------------------------------------------------------------------------
class JykWkr : public AudioEffectX
{
public:
	JykWkr (audioMasterCallback audioMaster);
	virtual ~JykWkr();
#ifndef USE_IRR
