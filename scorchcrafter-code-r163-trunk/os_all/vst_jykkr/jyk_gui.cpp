...
AEffGUIEditor* createEditor (AudioEffectX* JykWkr)
{
	return new PlgEditor (JykWkr);
}
//------------------------------------------------------------------------------------
...
//	DisplaySide = ((JykWkr*)effect)->getParameter(kGuiCurrentPanel);

	if(((JykWkr*)effect)->getParameter(kGuiPanelButtonA) > 0.50f) SetUpFront();

	if(((JykWkr*)effect)->getParameter(kGuiPanelButtonB) > 0.50f) SetUpBack();

	if(((JykWkr*)effect)->getParameter(kGuiPanelButtonC) > 0.50f) SetUpAux();
...
//		setParameter (i, ((JykWkr*)effect)->getParameter (i));
...
void PlgEditor::SetUpFront()
{
	...
	PanelButton[0]->setValue(((JykWkr*)effect)->getParameter(kGuiPanelButtonA));
	PanelButton[1]->setValue(((JykWkr*)effect)->getParameter(kGuiPanelButtonB));
	PanelButton[2]->setValue(((JykWkr*)effect)->getParameter(kGuiPanelButtonC));
	...
	kKnob[0]->setValue(((JykWkr*)effect)->getParameter(kGainControl));
	kKnob[1]->setValue(((JykWkr*)effect)->getParameter(kMasterVol));
	kKnob[2]->setValue(((JykWkr*)effect)->getParameter(kEQstackLow));
	kKnob[3]->setValue(((JykWkr*)effect)->getParameter(kEQstackMid));
	kKnob[4]->setValue(((JykWkr*)effect)->getParameter(kEQstackHigh));
	kKnob[5]->setValue(((JykWkr*)effect)->getParameter(kEQstackContour));
	kKnob[6]->setValue(((JykWkr*)effect)->getParameter(kEQstackPres));
	...
	kBtn_LoGain->setValue(((JykWkr*)effect)->getParameter(kBtnClean));
	kBtn_HiGain->setValue(((JykWkr*)effect)->getParameter(kBtnHeavy));
	kBtn_Boost->setValue(((JykWkr*)effect)->getParameter(kBtnBoost));
	kBtn_Stereo->setValue(((JykWkr*)effect)->getParameter(kMonoStereoControl));
	kBtn_Bright->setValue(((JykWkr*)effect)->getParameter(kBtnBright));
...
void PlgEditor::SetUpBack()
{
	...
	for(x = kSmpRenderOn1x; x <= kSmpRenderOnOFF; x++)
	{
		...
		SamplingOn[x-kSmpRenderOn1x]->setValue(((JykWkr*)effect)->getParameter(x));
	...
	for(x = kSmpRenderOff1x; x <= kSmpRenderOffOFF; x++)
	{
		...
		SamplingOff[x-kSmpRenderOff1x]->setValue(((JykWkr*)effect)->getParameter(x));
	...
	kBtn_TStackEven->setValue(((JykWkr*)effect)->getParameter(kToneStFlatEven));
	kBtn_TStackShaped[0]->setValue(((JykWkr*)effect)->getParameter(kToneStShapedA));
	kBtn_TStackShaped[1]->setValue(((JykWkr*)effect)->getParameter(kToneStShapedB));
	kBtn_TStackShaped[2]->setValue(((JykWkr*)effect)->getParameter(kToneStShapedC));
	kBtn_TStackShaped[3]->setValue(((JykWkr*)effect)->getParameter(kToneStShapedD));
	kBtn_TStackShaped[4]->setValue(((JykWkr*)effect)->getParameter(kToneStShapedE));
	kBtn_TStackShaped[5]->setValue(((JykWkr*)effect)->getParameter(kToneStShapedF));
	kBtn_CabMic->setValue(((JykWkr*)effect)->getParameter(kInternalCabOff));
	kBtn_CabMicSelect[0]->setValue(((JykWkr*)effect)->getParameter(kInternalCabA));
	kBtn_CabMicSelect[1]->setValue(((JykWkr*)effect)->getParameter(kInternalCabB));
	kBtn_CabMicSelect[2]->setValue(((JykWkr*)effect)->getParameter(kInternalCabC));
	kBtn_CabMicSelect[3]->setValue(((JykWkr*)effect)->getParameter(kInternalCabD));
	kBtn_CabMicSelect[4]->setValue(((JykWkr*)effect)->getParameter(kInternalCabE));
	kBtn_CabMicSelect[5]->setValue(((JykWkr*)effect)->getParameter(kInternalCabF));
	kDynamicToneOn->setValue(((JykWkr*)effect)->getParameter(kDynamicEnabled));
...
void PlgEditor::SetUpAux()
{
	...
	kBitDepthOn[0]->setValue(((JykWkr*)effect)->getParameter(kSmpBitOn32));
	kBitDepthOn[1]->setValue(((JykWkr*)effect)->getParameter(kSmpBitOn64));
	kBitDepthOn[2]->setValue(((JykWkr*)effect)->getParameter(kSmpBitOn128));
	kBitDepthOff[0]->setValue(((JykWkr*)effect)->getParameter(kSmpBitOff32));
	kBitDepthOff[1]->setValue(((JykWkr*)effect)->getParameter(kSmpBitOff64));
	kBitDepthOff[2]->setValue(((JykWkr*)effect)->getParameter(kSmpBitOff128));
...
void PlgEditor::valueChanged(CControl* pControl)
{
	...
	((JykWkr*)effect)->setParameterAutomated(pControl->getTag(), pControl->getValue());
}
//------------------------------------------------------------------------------------
void PlgEditor::setParameter(VstInt32 index, float value)
{
	...
	if(index == kGuiPanelButtonA)
	{
		if(frame)
		{
			...
			{
				SetUpFront();
//				((JykWkr*)effect)->setParameterAutomated(kGuiPanelButtonB, 0.0f);
//				((JykWkr*)effect)->setParameterAutomated(kGuiPanelButtonC, 0.0f);
			}
		}
	}
	if(index == kGuiPanelButtonB)
	{
		if(frame)
		{
			...
			{
				SetUpBack();
//				((JykWkr*)effect)->setParameterAutomated(kGuiPanelButtonA, 0.0f);
//				((JykWkr*)effect)->setParameterAutomated(kGuiPanelButtonC, 0.0f);
			}
		}
	}
...
//	{
	...
	//		((JykWkr*)effect)->updateDisplay();
		//	frame->invalid();
	//		DisplaySide = value;
	//	}
//	}
	if (((JykWkr*)effect)->getParameter(kGuiPanelButtonA) > 0.50f)
	{
	...
	if (((JykWkr*)effect)->getParameter(kGuiPanelButtonB) > 0.50f)
	{
	...
	if (((JykWkr*)effect)->getParameter(kGuiPanelButtonC) > 0.50f)
	{
