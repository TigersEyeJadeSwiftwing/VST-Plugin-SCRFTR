	...
	fpPrec(int (1))
{
	...
	h_EqBand_Freq[0][0] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 60.0 / fhx (sRate)));
	h_EqBand_Freq[1][0] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 300.0 / fhx (sRate)));
	h_EqBand_Freq[2][0] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 350.0 / fhx (sRate)));
	h_EqBand_Freq[3][0] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 1000.0 / fhx (sRate)));
	h_EqBand_Freq[4][0] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 700.0 / fhx (sRate)));
	h_EqBand_Freq[5][0] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 3000.0 / fhx (sRate)));

	h_EqBand_Freq[0][1] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 350.0 / fhx (sRate)));
	h_EqBand_Freq[1][1] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 500.0 / fhx (sRate)));
	h_EqBand_Freq[2][1] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 700.0 / fhx (sRate)));
	h_EqBand_Freq[3][1] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 2000.0 / fhx (sRate)));
	h_EqBand_Freq[4][1] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 1000.0 / fhx (sRate)));
	h_EqBand_Freq[5][1] = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 7000.0 / fhx (sRate)));

	h_outputF_a_frq = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 2000.0 / fhx (sRate)));
	h_outputF_b_frq = fhx ((fhx) 1.0 - (fhx) expl((fhx) -2.0 * (fhx) M_PI * (fhx) 18000.0 / fhx (sRate)));
...
/*
	...
	if(fpPrec == 2)
	{
		...
		h_subSpl[0] *= fhx (fhx (fhx (fhx (h_bValue[0]) * fhx (h_bValue[0])) * fhx (2.0)) - fhx (0.50));
		h_subSpl[2] *= fhx (fhx (fhx (fhx (h_bValue[1]) * fhx (h_bValue[1])) * fhx (2.0)) - fhx (0.50));
		h_subSpl[4] *= fhx (fhx (fhx (fhx (h_bValue[2]) * fhx (h_bValue[2])) * fhx (2.0)) - fhx (0.50));
		h_subSpl[1] *= fhx (fhx (fhx (h_bValue[3]) * fhx (h_bValue[3])) * fhx (2.0));
		h_subSpl[3] *= fhx (fhx (fhx (h_bValue[4]) * fhx (h_bValue[4])) * fhx (2.0));
		h_subSpl[5] *= fhx (fhx (fhx (h_bValue[5]) * fhx (h_bValue[5])) * fhx (2.0));
