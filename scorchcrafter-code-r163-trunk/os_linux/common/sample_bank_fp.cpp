	...
	precisionLevel(int (0))
{
	...
	const fhx filtFactorA = fhx (0.250000);
	const fhx filtFactorB = fhx (0.500000);
	const fhx filtFactorC = fhx (1.000000);
	const fhx filtFactorD = fhx (2.000000);
	const fhx filtFactorE = fhx (4.000000);
...
void SampleBank_FP::setSampleRate(fsx nSRate)
{
	...
	fsx filtFC[] = {0.250, 0.500, 1.000, 2.000, 4.000};
