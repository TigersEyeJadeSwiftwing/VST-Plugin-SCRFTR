...
#define DIST_TBa_MAX_STAGES 16

#define DIST_TBa_STAGES_CLEAN 3
#define DIST_TBa_STAGES_CRUNCH 4
#define DIST_TBa_STAGES_HIGH 10
#define DIST_TBa_STAGES_MEGA 16

#define DIST_TBa_STAGES_CLEAN_wRate 1.1250 // 1.50
#define DIST_TBa_STAGES_CRUNCH_wRate 0.350 // 0.750
#define DIST_TBa_STAGES_HIGH_wRate 0.2750 // 0.6250
#define DIST_TBa_STAGES_MEGA_wRate 0.2000 // 0.7250

#define DIST_TBa_STAGES_CLEAN_tHrm 0.1250
#define DIST_TBa_STAGES_CRUNCH_tHrm 0.2250
#define DIST_TBa_STAGES_HIGH_tHrm 0.20
#define DIST_TBa_STAGES_MEGA_tHrm 0.20

class Tube_BankA : public SampleBank_FP
{
public:
	Tube_BankA(fsx spRate);
	~Tube_BankA();
	void InitTubes();
	void zeroAllSamples();
